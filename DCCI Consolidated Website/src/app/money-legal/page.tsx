...
const subPages = [
  { icon: Shield, href: '/money-legal/medicare', title: 'Medicare & Health Insurance',
    description: 'Free SHINE counseling from trained volunteers, SMP Medicare fraud prevention, and ACA Marketplace navigators.', accent: 'bg-healthblue-100 text-healthblue-700' },
  { icon: DollarSign, href: '/money-legal/medicaid', title: 'Medicaid & Long-Term Care Funding',
    description: 'CARES eligibility assessment, SMMC-LTC enrollment, PACE program, and ADRC navigation.', accent: 'bg-sage-100 text-sage-700' },
  { icon: CreditCard, href: '/money-legal/financial-assistance', title: 'Financial Assistance Programs',
    description: 'EHEAP energy help, HCE caregiver stipend, Medicare, Medicaid, VA benefits, SSDI, food, and housing assistance.', accent: 'bg-lavender-100 text-lavender-700' },
  { icon: FileText, href: '/money-legal/legal-planning', title: 'Legal Planning',
    description: 'Power of attorney, healthcare surrogates, advance directives, wills, elder law, and the Florida Caregiver Toolkit.', accent: 'bg-warmgray-100 text-warmgray-700' },
]

export default function MoneyLegalPage() {
  return (
    <article>
      <div className="p-5 rounded-2xl bg-sage-50 border border-sage-200 mb-10">
