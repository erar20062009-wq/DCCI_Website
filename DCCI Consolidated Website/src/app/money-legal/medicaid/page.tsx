      ...
      <div className="space-y-4 mb-10">
        {[
          ...
          <div key={p.name} className={`rounded-2xl border p-5 ${p.color}`}>
            ...
            <a href="tel:+18009635337" className="flex items-center gap-1.5 text-sm font-medium text-lavender-600 hover:text-lavender-700 transition-colors"><Phone className="w-3.5 h-3.5" aria-hidden />1-800-963-5337 — Elder Helpline</a>
          </div>
        ))}
      </div>

      <p className="text-sm text-warmgray-400">
        For more on long-term care facility options, see <Link href="/care-services/long-term-care" className="text-lavender-600 hover:text-lavender-700 font-medium transition-colors">Long-Term Care Options →</Link>
      </p>
    </article>
  )
}
