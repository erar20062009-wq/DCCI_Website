...
const sidebarLinks = [
  ...
  { label: 'Warning Signs vs. Normal Aging', href: '/signs-diagnosis/warning-signs' },
  { label: 'The 10 Early Signs', href: '/signs-diagnosis/10-signs' },
  ...
  return (
    <div className="pt-header">
      <SectionHero
        ...
        gradient="bg-gradient-to-b from-lavender-50/80 to-white"
