...
const subPages = [
  { icon: Calendar, href: '/care-services/respite', title: 'Respite & Adult Day Programs',
    description: "Social Clubs (5 Big Bend locations), in-home respite, AmeriCorps volunteer respite for veterans, and ADI emergency respite.", accent: 'bg-teal-100 text-teal-700' },
  { icon: Home, href: '/care-services/in-home', title: 'In-Home & Community Services',
    description: 'CCE, Home Care for the Elderly (HCE), ADI in-home services, OAA meals — how the Elder Helpline intake works.', accent: 'bg-lavender-100 text-lavender-700' },
  { icon: Building2, href: '/care-services/long-term-care', title: 'Long-Term Care Options',
    description: 'SMMC-LTC Medicaid managed long-term care, PACE, CARES assessment, ADRC navigation.', accent: 'bg-healthblue-100 text-healthblue-700' },
  { icon: Shield, href: '/care-services/home-safety', title: 'Home Safety & Daily Care',
    description: 'Falls prevention, fire safety, kitchen safety, sleep challenges, wandering, and the "safe sitting" technique.', accent: 'bg-amber-100 text-amber-700' },
  ...
  { icon: Car, href: '/care-services/transportation', title: 'Transportation & Driving',
    description: 'Senior transport options, dementia-friendly transit training, Safe Mobility for Life, and driving cessation guidance.', accent: 'bg-warmgray-100 text-warmgray-700' },
]
  ...
  return (
    <article>
      <div className="p-5 rounded-2xl bg-healthblue-50 border border-healthblue-200 mb-10">
        <p className="text-sm text-healthblue-800">
          ...
          return (
            <Link key={page.href} href={page.href}
              ...
              <div className="flex-1 min-w-0">
                <h2 className="text-base font-bold text-warmgray-900 mb-1 group-hover:text-lavender-700 transition-colors">{page.title}</h2>
